...
import { ArrowLeft, Download, Printer as Print, BookOpen } from 'lucide-react';
...
const InvoicePage: React.FC = () => {
  ...
  const invoiceNumber = `2025-${Math.floor(Math.random() * 10000).toString().padStart(4, '0')}`;
  ...
  const handleDownload = () => {
    ...
    alert('Fonctionnalité de téléchargement à implémenter avec un service backend');
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Aucune facture à afficher</h2>
          ...
          <div className="p-8">
            ...
            <div className="flex justify-between items-start mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-blue-600">THE SEVEN ENGINEER</h1>
                  <p className="text-gray-600">Centre de Formation & Bureau d'Étude</p>
                </div>
              </div>
              <div className="text-right">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">FACTURE - {invoiceNumber}</h2>
                <p className="text-gray-600">Date de facturation: {formatDate(today)}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="font-bold text-gray-900 mb-3">THE SEVEN ENGINEER - Centre de formation</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">{user?.name || 'Client'}</h3>
                <div className="text-gray-600 space-y-1">
            ...
            {/* Thank you message */}
            <div className="mb-6">
              <p className="text-gray-700">Merci d'avoir choisi THE SEVEN ENGINEER !</p>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-900">Qté</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-900">Unité</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-900">Prix unitaire</th>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-900">TVA</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {items.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-900">{formatDate(today)}</td>
                      <td className="px-4 py-3 text-sm text-gray-900">{typeof item.quantity === 'number' ? item.quantity.toFixed(2) : '1.00'}</td>
                      <td className="px-4 py-3 text-sm text-gray-900">{item.type === 'course' ? 'formation' : 'pce'}</td>
                      <td className="px-4 py-3 text-sm text-gray-900">{item.price.toFixed(2)} €</td>
                      <td className="px-4 py-3 text-sm text-gray-900">20,0 %</td>
              ...
              <div className="w-64">
                ...
                <div className="border-t border-gray-300 pt-2">
                  <div className="flex justify-between py-2">
                    ...
                    <span className="text-lg font-bold">{totalTTC.toFixed(2)} €</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-2">Conditions de paiement:</h4>
            ...
            <div className="text-center text-gray-600 text-sm border-t border-gray-200 pt-6">
              <p className="font-medium">THE SEVEN ENGINEER - Centre de formation</p>
