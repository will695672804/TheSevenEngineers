      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">Découvrez nos formations et produits pour commencer vos achats</p>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-lg font-bold text-gray-900">{(total * 1.2).toFixed(2)}€</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">Garantie satisfait ou remboursé</p>
              </div>
            </div>
          </div>
        </div>
