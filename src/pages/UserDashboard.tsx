      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
                    ...
                    {enrolledCourses.slice(0, 3).map(course => (
                      <div key={course.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">Progression: {course.progress || 0}%</p>
                        </div>
            ...
            {activeTab === 'courses' && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Mes Formations</h2>
                  ...
                  <>
                    {enrolledCourses.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 mb-2">Aucune formation suivie</h3>
                        <p className="text-gray-600">Découvrez nos formations pour commencer votre apprentissage</p>
                      </div>
                    )}
                  </>
                )}
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                {userOrders.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">Vos commandes apparaîtront ici</p>
                  </div>
                )}
              </div>
            )}
